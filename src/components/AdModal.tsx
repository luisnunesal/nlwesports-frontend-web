...
export function AdModal() {
    ...
    const [useVoicelChannel, setUseVoiceChannel] = useState<boolean>(false);
    ...
    async function handleCreateAd(event: FormEvent) {
        ...
        const data = Object.fromEntries(formData);
         //só pra nao enviar o codigo vazio, mas falta validação
        if(!data.name){
            return
        }
        ...
        try {
            await axios.post(`http://localhost:3333/games/${data.game}/ads`,{
                ...
                useVoiceChannel: useVoicelChannel
            })
                ...
                <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        <div className="flex flex-col gap-2">
                            ...
                            <Input id="yearsPlaying" name="yearsPlaying" type="numer" placeholder="Tudo bem ser ZERO" />
                        </div>
                        <div className="flex flex-col gap-2">
